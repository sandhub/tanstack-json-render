...
<table>
  ...
  <tbody>
    <tr>
      <td>React</td>
      <td><code>@tanstack-json-render/react</code></td>
      <td>React component tree</td>
    </tr>
    <tr>
      <td>Vue</td>
      <td><code>@tanstack-json-render/vue</code></td>
      <td>Vue 3 component tree</td>
    </tr>
    <tr>
      <td>shadcn/ui</td>
      <td><code>@tanstack-json-render/shadcn</code></td>
      <td>Pre-built Radix UI + Tailwind components (uses React renderer)</td>
    </tr>
    <tr>
      <td>React Native</td>
      <td><code>@tanstack-json-render/react-native</code></td>
      <td>Native mobile views</td>
    </tr>
    <tr>
      <td>Image</td>
      <td><code>@tanstack-json-render/image</code></td>
      <td>SVG / PNG (via Satori)</td>
    </tr>
    <tr>
      <td>React PDF</td>
      <td><code>@tanstack-json-render/react-pdf</code></td>
      <td>PDF documents</td>
    </tr>
    <tr>
      <td>Remotion</td>
      <td><code>@tanstack-json-render/remotion</code></td>
...
Use `StateProvider`, `VisibilityProvider`, and `ActionProvider` for full interactivity. See the [@tanstack-json-render/react API reference](/docs/api/react) for details.
...
Uses composables (`useStateStore`, `useStateBinding`, `useActions`, etc.) instead of React hooks. See the [@tanstack-json-render/vue API reference](/docs/api/vue) for details.

## shadcn/ui

36 pre-built components using Radix UI and Tailwind CSS. Built on top of `@tanstack-json-render/react` -- no custom renderer needed.
...
See the [@tanstack-json-render/shadcn API reference](/docs/api/shadcn) for the full component list.
...
import { standardComponentDefinitions, standardActionDefinitions } from "@tanstack-json-render/react-native/catalog";
...
See the [@tanstack-json-render/react-native API reference](/docs/api/react-native) for details.
...
See the [@tanstack-json-render/image API reference](/docs/api/image) for details.
...
See the [@tanstack-json-render/react-pdf API reference](/docs/api/react-pdf) for details.
...
See the [@tanstack-json-render/remotion API reference](/docs/api/remotion) for details.
