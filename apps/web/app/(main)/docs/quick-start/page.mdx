...
import { Renderer, StateProvider, ActionProvider, VisibilityProvider, ValidationProvider, useUIStream } from '@tanstack-json-render/react';
...
If you want to skip defining components from scratch, use `@tanstack-json-render/shadcn` for 36 pre-built components:
