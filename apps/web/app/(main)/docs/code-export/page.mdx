...
### 1. @tanstack-json-render/codegen (utilities)
...
import { collectUsedComponents, serializeProps } from '@tanstack-json-render/codegen';
...
```typescript
import { collectUsedComponents } from '@tanstack-json-render/codegen';
...
```typescript
import { serializeProps } from '@tanstack-json-render/codegen';
