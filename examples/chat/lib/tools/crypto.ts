...
export const getCryptoPrice = getCryptoPriceDef.server(async ({ coinId }) => {
...
const getCryptoPriceHistoryDef = toolDefinition({
...
export const getCryptoPriceHistory = getCryptoPriceHistoryDef.server(
  async ({ coinId, days }) => {
